# Generated by Django 2.2 on 2019-05-04 22:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Grade', models.CharField(choices=[('A+', 'A+'), ('A', 'A'), ('A-', 'A-'), ('B+', 'B+'), ('B', 'B'), ('B-', 'B-'), ('C+', 'C+'), ('C', 'C'), ('C-', 'C-'), ('D+', 'D+'), ('D', 'D'), ('D-', 'D-'), ('F', 'Fail'), ('W', 'Withdraw'), ('I', 'Incomplete')], max_length=255)),
                ('Student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Curriculum.Person')),
            ],
            options={
                'db_table': 'Grade',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Associated_Grade_Dist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Curriculum.Grade')),
            ],
            options={
                'db_table': 'Goal',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Associated_Course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Curriculum.Course')),
                ('Associated_Grade_Distribution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Curriculum.Grade')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='grade',
            constraint=models.UniqueConstraint(fields=('Grade_Distribution_ID', 'Student'), name='grade_unique'),
        ),
        migrations.AddConstraint(
